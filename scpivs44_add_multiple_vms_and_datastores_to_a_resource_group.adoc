...
.Passos
. No painel Navegador esquerdo do plug-in SCV, clique em *grupos de recursos*, selecione um grupo de recursos e clique  em *Editar grupo de image:scpivs44_image39.png["Erro: Imagem gráfica em falta"]recursos* para iniciar o assistente.
